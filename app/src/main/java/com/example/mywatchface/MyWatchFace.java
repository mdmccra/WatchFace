    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            if (isInAmbientMode()) {
                ...
                canvas.drawCircle(mXOffset + 170, mYOffset + 70, 35, paint);
                paint.setColor(Color.WHITE);
                canvas.drawText(s, mXOffset + 150, mYOffset + 85, paint);

                paint.setTextSize(30);
                canvas.drawText("Taps: ", 90, 215, paint);
            }
            ...
            canvas.drawText(text, mXOffset + 20, mYOffset, mTextPaint);
        }
